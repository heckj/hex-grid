...
class HeapTests: XCTestCase {
    ...
    func testInsertArrayAndRemove() {
        ...
        heap.remove(node: 1)
        XCTAssertNil(heap.peek())
        XCTAssertNil(heap.remove(node: 1))
    }
    ...
    func testSort() {
        var heap = Heap<Int>(sort: >)
        heap.insert([1, 3, 2, 7, 5, 9])
        XCTAssertEqual(heap.sort(), [1, 2, 3, 5, 7, 9])
    }
    
    func testHeapsort() {
        let array = [1, 3, 2, 7, 5, 9]
    ...
    static let allTests = [
        ...
        ("Test max one element - heap", testMaxHeapOneElement),
        ("Test max - heap", testCreateMaxHeap),
        ("Test min - heap", testCreateMinHeap),
        ("Test max equal nodes - heap", testCreateMaxHeapEqualnodes),
        ("Test min equal nodes - heap", testCreateMinHeapEqualnodes),
        ("Test random max - heap", testCreateRandomMaxHeap),
        ("Test random min - heap", testCreateRandomMinHeap),
        ("Test removing - heap", testRemoving),
        ("Test remove empty - heap", testRemoveEmpty),
        ("Test remove root - heap", testRemoveRoot),
        ("Test remove random - heap", testRemoveRandomItems),
        ("Test insert - heap", testInsert),
        ("Test insert array remove - heap", testInsertArrayAndRemove),
        ("Test replace - heap", testReplace),
        ("Test sort - heap", testSort),
        ("Test heapsort", testHeapsort)
    ]
}
